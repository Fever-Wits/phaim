...
* [LENS-CATALOG.md](LENS-CATALOG.md) — Complete inventory of current lenses (175 entries, alphabetical, with "what it does", "when to apply", and "invocation site" for each)
